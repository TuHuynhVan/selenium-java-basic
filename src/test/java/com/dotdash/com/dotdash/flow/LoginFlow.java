...
public class LoginFlow {
    ...
    public void login() {
        this.login_page.input_username(this.username).input_password(this.password).click_on_login_btn();
    }

    public void verify_wrong_credentials_msg() {
        final String WRONG_MSG = "Your username is invalid!";
        String actual_msg = this.login_page.get_confirm_msg_after_login();
